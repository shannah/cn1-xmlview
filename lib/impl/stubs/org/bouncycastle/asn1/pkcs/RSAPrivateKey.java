...
public class RSAPrivateKey extends org.bouncycastle.asn1.ASN1Object {
	...
	public RSAPrivateKey(javabc.BigInteger modulus, javabc.BigInteger publicExponent, javabc.BigInteger privateExponent, javabc.BigInteger prime1, javabc.BigInteger prime2, javabc.BigInteger exponent1, javabc.BigInteger exponent2, javabc.BigInteger coefficient) {
	}

	public static RSAPrivateKey getInstance(org.bouncycastle.asn1.ASN1TaggedObject obj, boolean explicit) {
	}

	public static RSAPrivateKey getInstance(Object obj) {
	}

	public javabc.BigInteger getVersion() {
	}
